...
stock_agent_skill = a2a_types.AgentSkill(
    # Unique identifier for this skill
    id="stock_prod",
    # Human-friendly name
    name="Controlar Stock de Productos",
...
stock_agent_card = create_agent_card(
    agent_name="Stock Agent",
    description="Agente que controla el stock de productos",
    skills=[stock_agent_skill],
)
