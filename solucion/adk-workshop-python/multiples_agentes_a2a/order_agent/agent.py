...
def order_producto(producto: str, cantidad: int) -> str:
    """Crea ordenes de compra de un producto particular.
...
order_agent_card = create_agent_card(
    agent_name="Order Agent",
    description="Agente que crea ordenes de compra de productos",
    skills=[order_agent_skill],
)
