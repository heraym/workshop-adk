...
AGENT_RESOURCE_NAME = "projects/224237244779/locations/us-central1/reasoningEngines/1254169483094786048"
async def main():
  ...
  remote_session = await remote_app.async_create_session(user_id="test-user-123", state=user_profile)
