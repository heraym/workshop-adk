...
A. Gemini 3.6 Flash: Implicit vs explicit caching comparison
"""
...
async def run_cache_comparison_experiment(
  ...
  Args:
      model_name: Model to test (e.g., "gemini-3.5-flash")
...
def get_experiment_labels(model_name: str) -> Dict[str, str]:
    ...
    # Gemini 3.x models have implicit caching
    return {
...
async def main():
  ...
  parser.add_argument(
      "model",
      help="Model to test (e.g., gemini-3.5-flash)",
  )
  parser.add_argument(
      "--output",
